...
- [x] **Step 1: Record source evidence before authoring**
...
- [x] **Step 2: Add 12 breakfast recipes**
...
- [x] **Step 4: Add 8 meal-prep staples/sauces**
...
- [x] **Step 5: Wire the category arrays into the public index and test counts**
...
- [x] **Step 1: Add 18 dinner recipes**
...
- [x] **Step 3: Add source provenance and nutrition caveats**
...
- [x] **Step 4: Add count and slug integrity tests**
...
- [x] **Step 3: Implement client-side search, filter, and sort**
...
- [x] **Step 4: Implement the server-rendered hub page**
...
- [x] **Step 1: Write the failing detail-route checks**
...
- [x] **Step 3: Add Recipe structured data**
...
- [x] **Step 4: Run the build and focused checks**
...
- [x] **Step 1: Add the Recipes navigation item**
...
- [x] **Step 2: Add recipe sitemap entries**
...
- [x] **Step 3: Extend launch-readiness tests**
...
- [x] **Step 5: Start the local preview and verify representative routes**
